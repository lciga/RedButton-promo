...
<template>
  <main class="screen" :class="[`screen--${scene}`, { 'screen--pulse': glitching }]">
    ...
    <div v-if="scene === 'glitch'" class="rupture" aria-hidden="true">
      <span v-for="line in 9" :key="line" class="rupture__line">SYSTEM FAILURE // {{ line }}0{{ line }}</span>
    </div>
...
.screen--glitch{animation:blackout 1.45s steps(1)}.screen--glitch .terminal{animation:terminal-rupture 1.45s steps(1)}.rupture{z-index:7;display:grid;align-content:center;color:#fff;font-size:clamp(12px,3vw,34px);font-weight:900;letter-spacing:.15em;mix-blend-mode:difference;animation:rupture .14s steps(2) infinite}.rupture__line{white-space:nowrap;overflow:hidden}.rupture__line:nth-child(odd){color:#ff173c;text-align:right;transform:translateX(-9vw)}.rupture__line:nth-child(even){color:#00eaff;transform:translateX(12vw)}
...
@keyframes rupture{0%{clip-path:inset(0);transform:skewX(0)}35%{clip-path:inset(18% 0 38%);transform:skewX(13deg) scaleX(1.15)}70%{clip-path:inset(54% 0 4%);transform:skewX(-8deg) scaleX(.9)}}@keyframes terminal-rupture{0%{transform:translate(0)}8%{transform:translate(-8vw,2px) scaleX(1.2);filter:invert(1)}13%{transform:translate(7vw,-4px)}22%{transform:scaleY(.04)}30%{transform:scaleY(1.1) skewX(12deg);filter:hue-rotate(140deg)}43%{opacity:.12;transform:translateX(-15vw)}52%{opacity:1;transform:translateX(12vw) scaleX(.7)}68%{transform:scale(1.5);filter:invert(1) contrast(3)}74%,100%{opacity:0;transform:scaleY(0)}}@keyframes blackout{0%,20%,49%,72%{background-color:#000}8%,31%{background-color:#effff0}55%{filter:hue-rotate(160deg) contrast(2)}76%,100%{background-color:#000}}@keyframes reveal{0%{opacity:0;filter:blur(12px);transform:scaleY(.05)}35%{opacity:1;filter:blur(0);transform:scaleY(1.05) translateX(8px)}55%{opacity:.2;transform:translateX(-5px)}100%{opacity:1;transform:none}}
